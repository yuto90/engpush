...
class _$ReminderImpl implements _Reminder {
  const _$ReminderImpl({required this.number, required this.time});
  ...
  @override
  String toString() {
    return 'Reminder(number: $number, time: $time)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, number, time);
...
abstract class _Reminder implements Reminder {
  const factory _Reminder(
      {required final int number, required final int time}) = _$ReminderImpl;
